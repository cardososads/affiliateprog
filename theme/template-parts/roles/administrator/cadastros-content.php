	...
	foreach ($dados as $linha) {
		...
		foreach ($linha as $chave => $valor) {
			...
			if (in_array($chave, $colunas_tabela)) {
				...
				// Aplica a máscara de CNPJ se for o campo CNPJ
				if ($chave == 'cnpj') {
...
verificar_compatibilidade_campos_e_inserir($dados_tratados, 'validate_cnpjs');
...
$resultados = meu_acesso_tabela('validate_cnpjs', $filtros);
