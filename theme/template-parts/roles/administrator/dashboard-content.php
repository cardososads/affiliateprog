<section class="mt-5 flex flex-col gap-[40px]">
	...
	<!--Aprovações-->
<!--	<div class="w-full rounded-[10px] bg-white p-[40px]">-->
<!--		<h2 class="text-gray-700 text-[25px] font-semibold leading-[35px] pb-[20px]">Solicitações de aprovação recentes</h2>-->
