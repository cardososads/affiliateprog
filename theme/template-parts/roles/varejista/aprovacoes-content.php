<section class="flex flex-wrap bg-white p-[30px]">
	<div class="flex flex-col grow shrink-0 self-start basis-0 w-fit max-md:max-w-full">
		<h2 class="text-2xl font-semibold leading-9 text-gray-700 max-w-full mb-5">Lista de Aprovações</h2>
		<div class="grid grid-cols-2 gap-5 w-full">
			<!--Card-->
			<div class="px-[50px] py-[20px] bg-[#f1f1f1] rounded-[10px] shadow">
				<div class="flex gap-[40px]">
					...
					<div class="flex flex-col justify-center items-center gap-[22px]">
						<div class="flex gap-[21px] items-center justify-center">
							<button class="text-nowrap px-[10px] py-[5px] gap-[2px] bg-verde rounded text-white text-[10px] font-semibold">
								Ver usuário
							</button>
							<button class="text-nowrap px-[10px] py-[5px] gap-[2px] bg-red-700 rounded text-white text-[10px] font-semibold">
								Reprovar
							</button>
						</div>
					</div>
