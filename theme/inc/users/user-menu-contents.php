		...
		case 'administrator':
			$contents = array(
				'dashboard' => [
					...
					'icon' => "<svg class='w-6 h-6 text-verde-inter' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='#41837F' viewBox='0 0 24 24'><path fill-rule='evenodd' d='M2 12a10 10 0 1 1 20 0 10 10 0 0 1-20 0Zm9.4-5.5a1 1 0 1 0 0 2 1 1 0 1 0 0-2ZM10 10a1 1 0 1 0 0 2h1v3h-1a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-1v-4c0-.6-.4-1-1-1h-2Z' clip-rule='evenodd'/></svg>"
				],
				'produtos' => [
					'title' => 'Produtos',
				...
				'aprovacoes' => [
					'title' => 'Aprovações',
					'icon' => "<svg class='w-6 h-6 text-verde-inter' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='#41837F' viewBox='0 0 24 24'><path fill-rule='evenodd' d='M2 12a10 10 0 1 1 20 0 10 10 0 0 1-20 0Zm13.7-1.3a1 1 0 0 0-1.4-1.4L11 12.6l-1.8-1.8a1 1 0 0 0-1.4 1.4l2.5 2.5c.4.4 1 .4 1.4 0l4-4Z' clip-rule='evenodd'/></svg>"
				],
				'mapa' => [
					'title' => 'Mapa',
					'icon' => "<svg class='w-6 h-6 text-verde-inter' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='#41837F' viewBox='0 0 24 24'><path fill-rule='evenodd' d='M12 2a8 8 0 0 1 6.6 12.6l-.1.1-.6.7-5.1 6.2a1 1 0 0 1-1.6 0L6 15.3l-.3-.4-.2-.2v-.2A8 8 0 0 1 11.8 2Zm3 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z' clip-rule='evenodd'/></svg>"
				],
				'configuracoes' => [
					'title' => 'Configurações',
